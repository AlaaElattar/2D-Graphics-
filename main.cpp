...
void draw(Drawing a, HWND hwnd) {
	...
	if (a.name == "DrawLineDDA") {
		DrawLineDDA(hdc, a.points[0].x, a.points[0].y, a.points[1].x, a.points[1].y, color);
	}
	else if (a.name == "DrawLineMidPoint") {
		drawLineMidPoint(hdc, a.points[0], a.points[1], color);
	}
	...
	/*----------------------------------*/
		...
		DrawCircleDirect(hdc, a.points[0], a.points[1], color);
	}
		...
		DrawCirclePolar(hdc, a.points[0].x, a.points[0].y, r, color);
	}
	else if (a.name == "DrawCircleIterativePolar") {
		int r = sqrt((a.points[0].x - a.points[1].x) * (a.points[0].x - a.points[1].x) + (a.points[0].y - a.points[1].y) * (a.points[0].y - a.points[1].y));
		DrawCircleIterativePolar(hdc, a.points[0].x, a.points[0].y, r, color);
	}
	else if (a.name == "DrawCircleMidPoint") {
		int r = sqrt((a.points[0].x - a.points[1].x) * (a.points[0].x - a.points[1].x) + (a.points[0].y - a.points[1].y) * (a.points[0].y - a.points[1].y));
		DrawCircleMidpoint(hdc, a.points[0].x, a.points[0].y, r, color);
	}
	else if (a.name == "DrawCircleModifiedMidPoint") {
		int r = sqrt((a.points[0].x - a.points[1].x) * (a.points[0].x - a.points[1].x) + (a.points[0].y - a.points[1].y) * (a.points[0].y - a.points[1].y));
		DrawCircleModifiedMidpoint(hdc, a.points[0].x, a.points[0].y, r, color);
	}
	/*----------------------------------*/
	else if (a.name == "DrawEllipseDirect") {
		DrawEllipseDirect(hdc, a.points[0], a.points[1], a.points[2], color);
	}
	else if (a.name == "DrawEllipsePolar") {
		DrawEllipsePolar(hdc, a.points[0], a.points[1], a.points[2], color);
	}
	else if (a.name == "DrawEllipsePolarIterative") {
		DrawEllipsePolarIterative(hdc, a.points[0], a.points[1], a.points[2], color);
	}
	else if (a.name == "DrawEllipseMidPoint") {
		DrawEllipseMidPoint(hdc, a.points[0], a.points[1], a.points[2], color);
	}
	/*----------------------------------*/
	else if (a.name == "DrawHermiteCurve") {
		DrawHermiteCurve(hdc, a.points[0], a.points[1], a.points[2], a.points[3], color);
	}
	else if (a.name == "DrawBezierCurve") {
		DrawBezierCurve(hdc, a.points[0], a.points[1], a.points[2], a.points[3], color);
	}
	else if (a.name == "DrawCardinalSpline") {
		DrawCardinalSpline(hdc, a.points, 6, 0, color);
	}
	/*----------------------------------*/
	else if (a.name.substr(0,a.name.size()-1) == "FillCircleLines") {
		int r = sqrt((a.points[0].x - a.points[1].x) * (a.points[0].x - a.points[1].x) + (a.points[0].y - a.points[1].y) * (a.points[0].y - a.points[1].y));
		q = a.name[a.name.size()-1];
		fillCircleWithLines(hdc, a.points[0].x, a.points[0].y,q, r, color);
	}
	else if (a.name.substr(0,a.name.size()-1) == "FillCircleCircles") {
		int r = sqrt((a.points[0].x - a.points[1].x) * (a.points[0].x - a.points[1].x) + (a.points[0].y - a.points[1].y) * (a.points[0].y - a.points[1].y));
		q = a.name[a.name.size()-1];
		fillCircleWithCircles(hdc, a.points[0].x, a.points[0].y,q, r, color);
	}
	else if (a.name == "FillSquareHermite") {
		int r = sqrt((a.points[0].x - a.points[1].x) * (a.points[0].x - a.points[1].x) + (a.points[0].y - a.points[1].y) * (a.points[0].y - a.points[1].y));
		fillSquareWithHermite(hdc, a.points[0].x, a.points[1].x, a.points[0].y, a.points[1].y, color);
	}
	else if (a.name == "FillRectBezier") {
		fillRectWithBezier(hdc, a.points[0].x, a.points[1].x, a.points[0].y, a.points[1].y, color);
	}
		...
		GeneralPolygonFill(hdc, tmp, 5, color);
	}
	else if (a.name == "Recursive-FloodFill") {
		recFloodFill(hdc, a.points[0].x, a.points[0].y, bColor, color);
	}
    else if (a.name == "NonRecursive-FloodFill") {
		floodFill(hdc, a.points[0].x, a.points[0].y, bColor, color);
	}
	/*----------------------------------*/
	// ----> Rectangle
		...
		RecPointClipping(hdc, a.points[0].x, a.points[0].y, t1.x, t1.y, t2.x, t2.y, color);
	}
	else if (a.name == "LineClipping-Rectangle") {

		RecCohenSuth(hdc, a.points[0].x, a.points[0].y, a.points[1].x, a.points[1].y, t1.x, t1.y, t2.x, t2.y, color);
	}
		...
		RecPolygonClip(hdc, p, t1.x, t1.y, t2.x, t2.y, color);
	}
		...
		SquarePointClipping(hdc, a.points[0].x, a.points[0].y, t1.x, t1.y, length, color);
	}
	else if (a.name == "LineClipping-Square") {
		SquareCohenSuth(hdc, a.points[0].x, a.points[0].y, a.points[1].x, a.points[1].y, t1.x, t1.y, length, color);
	}
	//Circle
		...
		t1.y = a.points[0].y;
		length = getLength(a.points[0].x, a.points[0].y, a.points[1].x, a.points[1].y);
		DrawCircleDirect(hdc, a.points[0], a.points[1], RGB(0, 0, 0));
	}
	else if (a.name == "PointClipping-Circle") {
		CirclePointClipping(hdc, a.points[0].x, a.points[0].y, t1.x, t1.y, length, color);

	}
	else if (a.name == "LineClipping-Circle") {
		CircleLineClipping(hdc, a.points[0].x, a.points[0].y, a.points[1].x, a.points[1].y, t1.x, t1.y, length, color);
	}
	//////////////////////////
	else if (a.name == "1") {
		CircleLineClipping(hdc, a.points[0].x, a.points[0].y, a.points[1].x, a.points[1].y, t1.x, t1.y, length, color);
...
LRESULT WINAPI MyWndProc(HWND hwnd, UINT mcode, WPARAM wp, LPARAM lp)
{
	...
	case WM_LBUTTONDOWN:
		...
		/*-----------------------------------------------------*/
			...
			add("DrawCircleIterativePolar", points);
			cnt = 0;
			bColor = color;
			points.clear();
			ReleaseDC(hwnd, hdc);
			...
			add("DrawCircleModifiedMidPoint", points);
			cnt = 0;
			bColor = color;
			points.clear();
			ReleaseDC(hwnd, hdc);
		...
		/*-----------------------------------------------------*/
			...
			add("Recursive-FloodFill", points);
			cnt = 0;
			points.clear();
			ReleaseDC(hwnd, hdc);
			...
			add("NonRecursive-FloodFill", points);
			cnt = 0;
			points.clear();
			ReleaseDC(hwnd, hdc);
		...
		/*-----------------------------------------------------*/
			...
			add("PointClipping-Rectangle", points);
			points.clear();
			cnt = 0;
			ReleaseDC(hwnd, hdc);
		}
			...
			add("LineClipping-Rectangle", points);
			points.clear();
			cnt = 0;
			ReleaseDC(hwnd, hdc);
		}
			...
			add("PolygonClipping-Rectangle", points);
			points.clear();
			cnt = 0;
			ReleaseDC(hwnd, hdc);
		}
			...
			add("PointClipping-Square", points);
			points.clear();
			cnt = 0;
			ReleaseDC(hwnd, hdc);
		}
			...
			add("LineClipping-Square", points);
			points.clear();
			cnt = 0;
			ReleaseDC(hwnd, hdc);
		}
			...
			add("PointClipping-Circle", points);
			points.clear();
			cnt = 0;
			ReleaseDC(hwnd, hdc);
		}
			...
			add("LineClipping-Circle", points);
			points.clear();
			cnt = 0;
			ReleaseDC(hwnd, hdc);
		}
